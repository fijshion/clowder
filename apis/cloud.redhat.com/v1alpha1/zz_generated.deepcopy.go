...
func (in *ClowdAppSpec) DeepCopyInto(out *ClowdAppSpec) {
	*out = *in
	...
	if in.Pods != nil {
		...
		*out = make([]PodSpecDeprecated, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PodSpecDeprecated) DeepCopyInto(out *PodSpecDeprecated) {
	*out = *in
	if in.MinReplicas != nil {
		in, out := &in.MinReplicas, &out.MinReplicas
		*out = new(int32)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodSpecDeprecated.
func (in *PodSpecDeprecated) DeepCopy() *PodSpecDeprecated {
	if in == nil {
		return nil
	}
	out := new(PodSpecDeprecated)
	in.DeepCopyInto(out)
	return out
}
